...
1. Buka aplikasi Termux di Android milikmu masing-masing.


2. Jika sudah berada didalam aplikasi Termux, silahkan ikuti perintah-perintah dibawah ini:
...
3. Sekarang kamu sudah ada didalam teks editor nano yang masih kosong. Silahkan salin kode script dibawah ini kemudian tempelkan kedalam teks editor tersebut.
...
Pastikan tidak ada kata atau kode yang terlewatkan.

4. Jika sudah, simpan script tersebut dengan  menggunakan CTRL + X + Y lalu enter.


5. Sekarang saatnya kamu menjalankan script loading yang sudah selesai dibuat dengan perintah:

 $ bash loading.sh 

dan script pun akan berjalan. Untuk menghentikannya gunakan CTRL + C.
